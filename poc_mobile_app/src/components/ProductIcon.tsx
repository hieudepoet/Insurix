...
// Single icon system for every product type, shared by every screen that
...
export function ProductIcon({
  ...
  if (product === "health") {
    return (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className={className}>
        <path
          d="M12 20.5S4 15.8 4 9.9A4.1 4.1 0 0 1 12 7a4.1 4.1 0 0 1 8 2.9c0 5.9-8 10.6-8 10.6Z"
          fill="currentColor"
        />
      </svg>
    );
